...
//                wordCloud.setColorPalette(new wordcloud.palette.ColorPalette(new Color(0x4055F1), new Color(0x408DF1), new Color(0x40AAF1), new Color(0x40C5F1), new Color(0x40D3F1), new Color(0xFFFFFF)));
                ...
                File tmp_file = new File("E:/Git/Live streaming-stormViz/stormtweetssentimentd3viz/web/assets/img/" + Constants.MAP_STATE_CODE_NAME.get(state) + ".png");
                if (tmp_file.exists()) {
                    tmp_file.delete();
                }
                try {
                    wordCloud.writeToFile("E:/Git/Live streaming-stormViz/stormtweetssentimentd3viz/web/assets/img/" + Constants.MAP_STATE_CODE_NAME.get(state) + ".png");

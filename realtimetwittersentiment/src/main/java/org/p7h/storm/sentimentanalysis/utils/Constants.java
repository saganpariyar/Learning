...
public final class Constants {
	...
	// name of the svc file 
	public static final String SVCINPUTFILE_NAME = "nectar_tweets.svc";
	
	// name of the output svc file 
	public static final String SVCOUTPUTFILE_NAME = "nectar_tweets_sentiment.svc";

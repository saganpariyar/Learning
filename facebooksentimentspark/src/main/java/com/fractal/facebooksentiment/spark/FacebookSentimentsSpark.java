package com.fractal.facebooksentiment.spark;
...
public class FacebookSentimentsSpark {

	private SparkConf sparkConf = new SparkConf().setAppName("FacebookPostSentimentAnalysis")
			.setMaster("local[2]");
	...
	public static void main(String args[]) {
		(new FacebookSentimentsSpark()).startSparkStreaming();
	}
